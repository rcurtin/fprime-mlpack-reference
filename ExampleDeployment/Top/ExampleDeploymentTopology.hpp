// ======================================================================
// \title  ExampleDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef EXAMPLEDEPLOYMENT_EXAMPLEDEPLOYMENTTOPOLOGY_HPP
#define EXAMPLEDEPLOYMENT_EXAMPLEDEPLOYMENTTOPOLOGY_HPP
// Included for access to ExampleDeployment::TopologyState and ExampleDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <ExampleDeployment/Top/ExampleDeploymentTopologyDefs.hpp>
 ...
 * ExampleDeployment::TopologyState see: ExampleDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type ExampleDeployment::TopologyState see: ExampleDeploymentTopologyDefs.hpp.
 *
