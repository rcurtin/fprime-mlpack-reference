...
#include <ExampleDeployment/Top/ExampleDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
static void signalHandler(int signum) {
    ExampleDeployment::stopRateGroups();
}
...
int main(int argc, char* argv[]) {
    ...
    ExampleDeployment::TopologyState inputs;
    ...
    ExampleDeployment::setupTopology(inputs);
    ExampleDeployment::startRateGroups();
    ExampleDeployment::teardownTopology(inputs);
